...
for shift = 0:sequence_length-1
    ...
    autocorr_value = mean(gold_sequence .* shifted_sequence) / autocorr_value_0; % Нормализация
...
cross_correlation = mean(gold_sequence .* gold_sequence_2) / autocorr_value_0; % Нормализация
